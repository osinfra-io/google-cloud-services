...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_datadog"></a> [datadog](#module\_datadog) | github.com/osinfra-io/terraform-datadog-google-integration//global | v0.1.2 |
...
| <a name="input_enabled_datadog"></a> [enabled\_datadog](#input\_enabled\_datadog) | Enable Datadog integration | `bool` | `false` | no |
| <a name="input_enabled_datadog_cloud_cost_management"></a> [enabled\_datadog\_cloud\_cost\_management](#input\_enabled\_datadog\_cloud\_cost\_management) | Enable Datadog cloud cost management | `bool` | `false` | no |
